...
namespace DownloadCFamilyPlugin
{
    internal static class Common
    {
        ...
        public static void DownloadJarFile(string url, string targetFilePath, TaskLoggingHelper logger)
        {
        ...
        public static string ExtractPluginFileNameFromUrl(string url, TaskLoggingHelper logger)
        {
        ...
        public static void UnzipJar(string jarFilePath, string destinationFolder, TaskLoggingHelper logger)
        {
        ...
        public static string DecompressGZipFile(string sourceFilePath, string destinationDirectory, TaskLoggingHelper logger)
        {
            var destFile = Path.Combine(destinationDirectory, Path.GetFileName(sourceFilePath)) + ".uncompressed";
            if (File.Exists(destFile))
            {
        ...
        public static List<string> FindSingleFiles(string searchRoot, IEnumerable<string> patterns, TaskLoggingHelper logger)
        {
        ...
        public static string FindSingleFile(string searchFolder, string pattern, TaskLoggingHelper logger)
        {
        ...
        private static void LogElapsedTime(string message, Stopwatch timer, TaskLoggingHelper logger)
        {
            LogMessage($"{message} {timer.Elapsed.ToString("g")}", logger);
        }

        private static void LogMessage(string message, TaskLoggingHelper logger)
        {
