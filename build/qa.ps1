...
#write the version to a property file for promotion job
$s="ARTIFACT=org/sonarsource/dotnet/SonarLint.VSIX/$version"
$s | out-file -encoding utf8 -append ".\artifact.properties"
#convert property file to unix for jenkins compatiblity
Get-ChildItem .\artifact.properties | ForEach-Object {
