...
namespace SonarLint.VisualStudio.Education.Layout
{
    ...
    /// </summary>
    internal class MultiSectionSection : IAbstractVisualizationTreeNode
    {
        private readonly IXamlBlockContent header;
        private readonly List<IAbstractVisualizationTreeNode> blocks;

        public MultiSectionSection(IXamlBlockContent header, List<IAbstractVisualizationTreeNode> blocks)
        {
            this.header = header;
            this.blocks = blocks;
        }
