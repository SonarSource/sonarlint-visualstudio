...
public class SonarLintXmlProviderTests
{
    ...
    {
        var profile = new RoslynAnalysisProfile([], []);
    ...
    public void Create_WithMultipleRulesAndProperties_ExpectedConfigurationSerialized()
    {
        ...
        var result = testSubject.Create(new RoslynAnalysisProfile([RuleWithoutParameters, RuleWithParameters], analysisProperties));
    ...
    {
        var profile = new RoslynAnalysisProfile([RuleWithoutParameters], []);
    ...
    {
        var profile = new RoslynAnalysisProfile([RuleWithParameters], []);
    ...
    public void Create_WithInactiveRules_OnlyIncludesActiveRules()
    {
        ...
        var profile = new RoslynAnalysisProfile(rules, []);
