...
//     {
//         analyzersLocator.GetBasicAnalyzerFullPathsByLanguage().Returns(new Dictionary<Language, List<string>>());
//
...
//         roslynAnalyzerLoader.LoadAnalyzerAssembly(csharpAnalyzerPath, out TODO).Returns([csharpAnalyzer]);
//         roslynAnalyzerLoader.LoadAnalyzerAssembly(vbAnalyzerPath, out TODO).Returns([vbAnalyzer]);
//
//         var result = testSubject.GetAnalyzersByLanguage();
//
...
//         roslynAnalyzerLoader.LoadAnalyzerAssembly(csharpAnalyzerPath, out TODO).Returns([csharpAnalyzer1, csharpAnalyzer2]);
//         roslynAnalyzerLoader.LoadAnalyzerAssembly(vbAnalyzerPath, out TODO).Returns([vbAnalyzer]);
//
//         var result = testSubject.GetAnalyzersByLanguage();
//
...
//         analyzersLocator.GetBasicAnalyzerFullPathsByLanguage().Returns(new Dictionary<Language, List<string>> { { Language.CSharp, [csharpAnalyzerPath1, csharpAnalyzerPath2] } });
...
//         roslynAnalyzerLoader.LoadAnalyzerAssembly(csharpAnalyzerPath1, out TODO).Returns([csharpAnalyzer1]);
//         roslynAnalyzerLoader.LoadAnalyzerAssembly(csharpAnalyzerPath2, out TODO).Returns([csharpAnalyzer2, csharpAnalyzer3]);
//
//         var result = testSubject.GetAnalyzersByLanguage();
//
