...
public class SequentialRoslynAnalysisEngineTests
{
    ...
    public void TestInitialize()
    {
        ...
        var roslynQuickFixFactory = Substitute.For<IRoslynQuickFixFactory>();
    ...
    private (IRoslynProjectWrapper project, IRoslynCompilationWithAnalyzersWrapper projectCompilation) SetupProjectAnalysisRequestAndCompilation(RoslynAnalysisConfiguration? analysisConfiguration = null)
    {
...

    {
        ...
        {
            issueConverter.Received(1).ConvertToSonarDiagnostic(diagnostic, roslynQuickFixes ?? Arg.Any<List<RoslynQuickFix>>(), language ?? Arg.Any<Language>());
        }
    }
