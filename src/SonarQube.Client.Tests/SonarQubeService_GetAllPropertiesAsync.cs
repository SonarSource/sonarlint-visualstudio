  ...
  },
  {
    ...
    ""value"": ""false""
            ...
            result.Select(x => x.Key).Should().BeEquivalentTo(
                new[] { "sonar.test.jira", "sonar.autogenerated", "sonar.demo", "sonar.demo.1.text", "sonar.demo.1.boolean", "sonar.demo.2.text", "sonar.demo.2.boolean" });
            result.Select(x => x.Value).Should().BeEquivalentTo(
                new[] { "abc", "val1,val2,val3", "1,2", "foo", "true", "bar", "false" });
        }
    ...
    },
    {
      ...
      ""inherited"": false
            ...
            result.Select(x => x.Key).Should().ContainInOrder(
                new[] { "sonar.test.jira", "sonar.autogenerated", "sonar.demo.1.boolean", "sonar.demo.1.text", "sonar.demo.2.boolean", "sonar.demo.2.text", });

            result.Select(x => x.Value).Should().ContainInOrder(
                new[] { "abc", "val1,val2,val3", "true", "foo", "false", "bar" });
        }
