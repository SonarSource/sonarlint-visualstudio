...
");
        ...
        [TestMethod]
        public async Task GetTaintVulnerabilitiesWithCCTAsync_Response_From_SonarQube()
        {
            ...
            SetupRequest("api/issues/search?additionalFields=ruleDescriptionContextKey&projects=shared&statuses=OPEN%2CCONFIRMED%2CREOPENED%2CRESOLVED&types=VULNERABILITY&p=1&ps=500", @"
{
	...
	""issues"": [
		...
		},
		{
			...
			""hash"": ""1703916771e6abb765843e62a76fcb5a"",
            ""cleanCodeAttribute"": ""CLEAR"",
            ""cleanCodeAttributeCategory"": ""INTENTIONALITY"",
            ""impacts"": [
                {
                    ""softwareQuality"": ""MAINTAINABILITY"",
                    ""severity"": ""HIGH""
		...
		},
		{
            ...
            ""cleanCodeAttributeCategory"": ""ADAPTABILITY"",
            ""impacts"": [
                {
