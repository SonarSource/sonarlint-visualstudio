...
namespace SonarLint.VisualStudio.SLCore {
    ...
    public class SLCoreStrings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Automatic binding setup failed.
        /// </summary>
        public static string AssistBindingFailed {
            get {
                return ResourceManager.GetString("AssistBindingFailed", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Automatic binding setup succeeded for configuration scope {0}.
        /// </summary>
        public static string AssistBindingSucceeded {
            get {
                return ResourceManager.GetString("AssistBindingSucceeded", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Automatic connection setup failed.
        /// </summary>
        public static string AssistConnectionFailed {
            get {
                return ResourceManager.GetString("AssistConnectionFailed", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to No valid server connection can be created from {0}.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to No compilation database found for file: {0}. Check that the file is part of a supported project type in the current solution..
        /// </summary>
        ...
        /// </summary>
        public static string ConnectedMode_LogContext {
            get {
                return ResourceManager.GetString("ConnectedMode_LogContext", resourceCulture);
            }
        }
        ...
        public static string FileExclusionsLogContext {
            get {
                return ResourceManager.GetString("FileExclusionsLogContext", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Analysis Configuration.
        /// </summary>
        public static string SLCoreAnalysisConfigurationLogContext {
            get {
                return ResourceManager.GetString("SLCoreAnalysisConfigurationLogContext", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Using compilation database defined in custom analysis properties located at {0}.
        /// </summary>
        public static string UserDefinedCompilationDatabase {
            get {
                return ResourceManager.GetString("UserDefinedCompilationDatabase", resourceCulture);
            }
        }
    }
}
