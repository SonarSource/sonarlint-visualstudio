...
internal sealed class SLCoreInstanceHandle : ISLCoreInstanceHandle
{
    ...
    public void Initialize()
    {
        ...
        lifecycleManagementSlCoreService.Initialize(new InitializeParams(
            ...
            extraEnabledLanguagesInConnectedMode: constantsProvider.LanguagesAddedInConnectedMode,
            disabledLanguagesForAnalysis: constantsProvider.LanguagesInStandaloneMode.Concat(constantsProvider.LanguagesAddedInConnectedMode).Except(constantsProvider.SLCoreAnalyzableLanguages).ToList(),
