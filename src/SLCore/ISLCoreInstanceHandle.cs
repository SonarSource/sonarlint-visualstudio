...
internal sealed class SLCoreInstanceHandle : ISLCoreInstanceHandle
{
    ...
    public void Initialize()
    {
        ...
        lifecycleManagementSlCoreService.Initialize(new InitializeParams(
            ...
            disabledLanguagesForAnalysis: constantsProvider.LanguagesInStandaloneMode.Concat(constantsProvider.ExtraLanguagesInConnectedMode).Except(constantsProvider.AnalyzableLanguages).ToList(),
