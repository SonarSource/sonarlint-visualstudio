...
namespace SonarLint.VisualStudio.SLCore.Service.Rules.Models
{
    public class RuleDescriptionTabDto
    {
        ...
        [JsonConverter(typeof(EitherJsonConverter<RuleNonContextualSectionDto, RuleContextualSectionWithDefaultContextKeyDto>))]
        public Either<RuleNonContextualSectionDto, RuleContextualSectionWithDefaultContextKeyDto> content { get; }
    }
}
