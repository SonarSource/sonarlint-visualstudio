...
{
    public RoslynSolutionWrapper(Solution workspaceCurrentSolution)
    {
        RoslynSolution = workspaceCurrentSolution;
        Projects = workspaceCurrentSolution.Projects.Select(x => new RoslynProjectWrapper(x, this));
    }
