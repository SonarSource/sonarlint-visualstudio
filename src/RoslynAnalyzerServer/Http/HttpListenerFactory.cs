...
{
    public HttpListener Create(int port)
    {
        var prefix = new UriBuilder(Uri.UriSchemeHttp, IPAddress.Loopback.ToString(), port).Uri.ToString();
