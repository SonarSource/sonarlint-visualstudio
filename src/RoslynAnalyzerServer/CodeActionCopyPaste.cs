...
public class CodeActionCopyPaste
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        foreach (var changedProject in solutionChanges.GetProjectChanges())
        {
            ...
            {
                var originalDocument = changedProject.OldProject.Solution.GetDocument(documentId); // todo
                var changedDocument = changedProject.NewProject.Solution.GetDocument(documentId); // todo
