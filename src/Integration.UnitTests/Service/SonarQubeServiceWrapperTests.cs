...
namespace SonarLint.VisualStudio.Integration.UnitTests
{
    public class SonarQubeServiceWrapperTests
    {
        ...
        public SonarQubeServiceWrapperTests()
        {
        ...
        {
            // Arrange + Act
            Action act = () => new SonarQubeServiceWrapper(null);
        ...
        public void SonarQubeServiceWrapper_TryGetProjects()
        {
            ...
            using (var testSubject = new TestableSonarQubeServiceWrapper(this.serviceProvider))
            {
                ...
                testSubject.TryGetProjects(connectionInfo2, CancellationToken.None, out projects)
                    .Should().BeTrue("Expected to get the projects");
        ...
        public void SonarQubeServiceWrapper_TryGetProjects_InvalidStatusCode()
        {
            using (var testSubject = new TestableSonarQubeServiceWrapper(this.serviceProvider))
            {
                ...
                // Act
                ProjectInformation[] projects = null;
                testSubject.TryGetProjects(connectionInfo, CancellationToken.None, out projects)
                    .Should().BeFalse("Should fail");
        ...
        public void SonarQubeServiceWrapper_TryGetProjects_Cancellation()
        {
            using (var testSubject = new TestableSonarQubeServiceWrapper(this.serviceProvider, timeoutInMilliseconds: 100))
            {
                ...
                using (var tokenSource = new CancellationTokenSource())
                {
                    ...
                    ProjectInformation[] projects = null;
                    testSubject.TryGetProjects(connectionInfo, CancellationToken.None, out projects)
                        .Should().BeFalse("Should be canceled");
        ...
        public void SonarQubeServiceWrapper_TryGetProjects_Authentication_Anonymous()
        {
            using (var testSubject = new TestableSonarQubeServiceWrapper(this.serviceProvider))
            {
                ...
                ProjectInformation[] projects = null;
                testSubject.TryGetProjects(connectionInfo, CancellationToken.None, out projects)
                    .Should().BeTrue("Should be get an empty array of projects");

                // Assert
                this.outputWindowPane.AssertOutputStrings(0);
                projects.Should().NotBeNull("Expected projects");
                projects.Should().HaveCount(0, "Expected an empty array");
            }
        }
        ...
        [Fact]
        public void TryGetProjects_WithNullConnectionInformation_ThrowsArgumentNullException()
        {
            // Arrange
            ...
            // Act
            Action act = () => testSubject.TryGetProjects(null, CancellationToken.None, out projects);
        ...
        public void SonarQubeServiceWrapper_TryGetProjects_UnhandledExceptions()
        {
            using (var testSubject = new TestableSonarQubeServiceWrapper(this.serviceProvider))
            {
                ...
                ProjectInformation[] projects = null;
                testSubject.TryGetProjects(connectionInfo, CancellationToken.None, out projects)
                    .Should().BeFalse("Exception been thrown");
        ...
        public void SonarQubeServiceWrapper_TryGetProperties()
        {
            using (var testSubject = new TestableSonarQubeServiceWrapper(this.serviceProvider))
            {
                ...
                testSubject.TryGetProperties(conn, CancellationToken.None, out actualProperties)
                    .Should().BeTrue("TryGetProperties failed unexpectedly");

                // Assert
                expectedProperties.Select(x => x.Key).Should().Equal(actualProperties.Select(x => x.Key).ToArray(), "Unexpected server property keys");
                expectedProperties.Select(x => x.Value).Should().Equal(actualProperties.Select(x => x.Value).ToArray(), "Unexpected server property values");
                handler.AssertHandlerCalled(1);
            }
        }

        [Fact]
        public void TryGetProperties_WithNullConnectionInformation_ThrowsArgumentNullException()
        {
            // Arrange
            var testSubject = new SonarQubeServiceWrapper(this.serviceProvider);
            ...
            // Act
            Action act = () => testSubject.TryGetProperties(null, CancellationToken.None, out properties);
        ...
        [Fact]
        public void TryGetQualityProfile_WithNullConnectionInfo_ThrowsArgumentNullException()
        {
            // Arrange
            var testSubject = new SonarQubeServiceWrapper(this.serviceProvider);
            ...
            // Act
            Action act = () => testSubject.TryGetQualityProfile(null, validProject, validLanguage, CancellationToken.None, out profile);
        ...
        [Fact]
        public void TryGetQualityProfile_WithNullProject_ThrowsArgumentNullException()
        {
            // Arrange
            var testSubject = new SonarQubeServiceWrapper(this.serviceProvider);
            QualityProfile profile;
            ...
            // Act
            Action act = () => testSubject.TryGetQualityProfile(validConnection, null, validLanguage, CancellationToken.None, out profile);
        ...
        [Fact]
        public void TryGetQualityProfile_WithUnsupportedLanguage_ThrowsArgumentOutOfRangeException()
        {
            // Arrange
            var testSubject = new SonarQubeServiceWrapper(this.serviceProvider);
            QualityProfile profile;
            ...
            // Act
            Action act = () => testSubject.TryGetQualityProfile(validConnection, validProject, cppLanguage, CancellationToken.None, out profile);
        ...
        public void SonarQubeServiceWrapper_TryGetQualityProfile_FullFunctionality()
        {
            using (var testSubject = new TestableSonarQubeServiceWrapper(this.serviceProvider))
            {
                ...
                testSubject.TryGetQualityProfile(conn, project, language, CancellationToken.None, out actualProfile)
                    .Should().BeTrue("TryGetExportProfile failed unexpectedly");
        ...
        private void SonarQubeServiceWrapper_TryGetExportProfile(Language language)
        {
            using (var testSubject = new TestableSonarQubeServiceWrapper(this.serviceProvider))
            {
                ...
                testSubject.TryGetExportProfile(conn, profile, language, CancellationToken.None, out actualExport)
                    .Should().BeTrue("TryGetExportProfile failed unexpectedly");
        ...
        [Fact]
        public void TryGetExportProfile_WithNullConnectionInformation_ThrowsArgumentNullException()
        {
            using (var testSubject = new TestableSonarQubeServiceWrapper(this.serviceProvider, timeoutInMilliseconds: 1))
            {
                // Arrange
                ...
                // Act
                Action act = () => testSubject.TryGetExportProfile(null, profile, Language.CSharp, CancellationToken.None, out actualExport);
        ...
        [Fact]
        public void TryGetExportProfile_WithNullQualityProfile_ThrowsArgumentNullException()
        {
            using (var testSubject = new TestableSonarQubeServiceWrapper(this.serviceProvider, timeoutInMilliseconds: 1))
            {
                // Arrange
                ...
                // Act
                Action act = () => testSubject.TryGetExportProfile(connection, null, Language.CSharp, CancellationToken.None, out actualExport);

                // Assert
                act.ShouldThrow<ArgumentNullException>().And.ParamName.Should().Be("profile");
        ...
        [Fact]
        public void TryGetExportProfile_WithInvalidLanguage_ThrowsArgumentOutOfRangeException()
        {
            using (var testSubject = new TestableSonarQubeServiceWrapper(this.serviceProvider, timeoutInMilliseconds: 1))
            {
                // Arrange
                ...
                // Act
                Action act = () => testSubject.TryGetExportProfile(connection, profile, pascalLanguage, CancellationToken.None, out actualExport);
        ...
        [Fact]
        public void TryGetPlugins_WithNullConnectionInformation_ThrowsArgumentNullException()
        {
            using (var testSubject = new TestableSonarQubeServiceWrapper(this.serviceProvider, timeoutInMilliseconds: 1))
            {
                // Arrange
                ...
                // Act
                Action act = () => testSubject.TryGetPlugins(null, CancellationToken.None, out plugins);
        ...
        public void SonarQubeServiceWrapper_TryGetPlugins()
        {
            using (var testSubject = new TestableSonarQubeServiceWrapper(this.serviceProvider))
            {
                ...
                testSubject.TryGetPlugins(connectionInfo, CancellationToken.None, out actualPlugins)
                    .Should().BeTrue("TryGetPlugins failed unexpectedly");

                // Assert
                actualPlugins.Select(x => x.Key).Should().Equal(expectedPlugins.Select(x => x.Key), "Unexpected server plugins");
                handler.AssertHandlerCalled(1);
            }
        }
        ...
        [Fact]
        public void CreateProjectDashboardUrl_WithNullConnectionInformation_ThrowsArgumentNullException()
        {
            // Arrange
            var testSubject = new SonarQubeServiceWrapper(this.serviceProvider);
            var projectInfo = new ProjectInformation { Key = "p1" };
            ...
            // Act
            Action act = () => testSubject.CreateProjectDashboardUrl(null, projectInfo);
        ...
        public void SonarQubeServiceWrapper_CreateProjectDashboardUrl_ArgChecks()
        {
            ...
            // Act
            Action act = () => testSubject.CreateProjectDashboardUrl(connectionInfo, null);
        ...
        private static void RegisterQualityProfileQueryValidator(TestableSonarQubeServiceWrapper testSubject)
        {
            testSubject.RegisterQueryValidator(SonarQubeServiceWrapper.QualityProfileListAPI, request =>
            {
                ...
                {
                    true.Should().BeFalse("Unexpected query params.: {0}", string.Join(", ", queryMap.Keys));
                }
            });
        }
