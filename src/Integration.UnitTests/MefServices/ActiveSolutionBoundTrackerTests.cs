...
namespace SonarLint.VisualStudio.Integration.UnitTests
{
    ...
    public class ActiveSolutionBoundTrackerTests
    {
        ...
        public ActiveSolutionBoundTrackerTests()
        {
        ...
        {
            // Arrange + Act
            Action act = () => new ActiveSolutionBoundTracker(null, new ConfigurableActiveSolutionTracker());
        ...
        [Fact]
        public void Ctor_WithNullSolutionTracker_ThrowsArgumentNullException()
        {
            // Arrange + Act
            Action act = () => new ActiveSolutionBoundTracker(this.host, null);
