 ...
 */
// todo remove https://sonarsource.atlassian.net/browse/SLVS-1408
// using System;
// using System.Linq;
...
//
//         private static readonly BoundServerProject ValidProject = new BoundServerProject("solution", "projectKey", new ServerConnection.SonarQube(new Uri("http://any")));
//         private static readonly BindCommandArgs ValidBindingArgs = new BindCommandArgs(ValidProject);
//
//         [TestInitialize]
