...
[TestClass]
public class JsTsTargetLanguagePredicateTests
{
    [TestMethod]
    ...
    [DataRow(AnalysisLanguage.Javascript, "js", true)]
    [DataRow(AnalysisLanguage.TypeScript, "ts", true)]
    [DataRow(AnalysisLanguage.Javascript, "jsx", true)]
    public void IsTargetLanguage_Returns(AnalysisLanguage language, string extension, bool expectedResult)
    {
        JsTsTargetLanguagePredicate.Instance.IsTargetLanguage(language, extension).Should().Be(expectedResult);
    }
}
