...
public class BindingSuggestionHandlerTests
{
        ...
        IBrowserService browserService = null)
    {
        ...
        activeSolutionBoundTracker.CurrentConfiguration.Returns(new BindingConfiguration2(new BoundServerProject("solution", "server project", new ServerConnection.SonarCloud("org")), sonarLintMode, "a-directory"));
