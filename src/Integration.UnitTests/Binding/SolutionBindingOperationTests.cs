...
namespace SonarLint.VisualStudio.Integration.UnitTests.Binding
{
    ...
    public class SolutionBindingOperationTests
    {
        ...
        public void SolutionBindingOperation_ArgChecks()
        {
            ...
            Exceptions.Expect<ArgumentNullException>(() => new SolutionBindingOperation(null, connectionInformation, "key", "name", SonarLintMode.LegacyConnected, logger, new ProjectBinderFactory(serviceProvider)));
            Exceptions.Expect<ArgumentNullException>(() => new SolutionBindingOperation(this.serviceProvider, null, "key", "name", SonarLintMode.LegacyConnected, logger, new ProjectBinderFactory(serviceProvider)));
            Exceptions.Expect<ArgumentNullException>(() => new SolutionBindingOperation(this.serviceProvider, connectionInformation, null, "name", SonarLintMode.LegacyConnected, logger, new ProjectBinderFactory(serviceProvider)));
            Exceptions.Expect<ArgumentNullException>(() => new SolutionBindingOperation(this.serviceProvider, connectionInformation, string.Empty, "name", SonarLintMode.LegacyConnected, logger, new ProjectBinderFactory(serviceProvider)));

            Exceptions.Expect<ArgumentOutOfRangeException>(() => new SolutionBindingOperation(this.serviceProvider, connectionInformation, "123", "name", SonarLintMode.Standalone, logger, new ProjectBinderFactory(serviceProvider)));
            Exceptions.Expect<ArgumentNullException>(() => new SolutionBindingOperation(this.serviceProvider, connectionInformation, "123", "name", SonarLintMode.LegacyConnected, null, new ProjectBinderFactory(serviceProvider)));
            ...
            var testSubject = new SolutionBindingOperation(this.serviceProvider, connectionInformation, "key", "name", SonarLintMode.LegacyConnected, logger, new ProjectBinderFactory(serviceProvider));
            ...
            ILogger logger = null)
        {
            return new SolutionBindingOperation(this.serviceProvider,
                ...
                new ProjectBinderFactory(serviceProvider),
                fileSystem);
        }
