...
namespace SonarLint.VisualStudio.Integration.UnitTests
{
    public class VsShellUtilsTests
    {
        ...
        public void VsShellUtils_ActivateSolutionExplorer()
        {
            ...
            // Sanity
            dteMock.ToolWindows.SolutionExplorer.Window.Active
                .Should().BeFalse();
            ...
            // Assert
            dteMock.ToolWindows.SolutionExplorer.Window.Active
                .Should().BeTrue("Expected to become Active");
        }
        ...
        public void VsShellUtils_SaveSolution_Silent()
        {
            ...
            {
                options.Should().Be((uint)__VSSLNSAVEOPTIONS.SLNSAVEOPT_SaveIfDirty, "Unexpected save options");
            ...
            // Act + Assert
            VsShellUtils.SaveSolution(serviceProvider, silent: true)
                .Should().BeTrue();
        }
        ...
        public void VsShellUtils_SaveSolution_Prompt()
        {
            ...
            solution.SaveSolutionElementAction = (options, hierarchy, docCookie) =>
            {
                ((__VSSLNSAVEOPTIONS)options).Should().Be(__VSSLNSAVEOPTIONS.SLNSAVEOPT_SaveIfDirty |
                    __VSSLNSAVEOPTIONS.SLNSAVEOPT_PromptSave, "Unexpected save options");
                hierarchy.Should().BeNull("Expecting the scope to be the whole solution");
                docCookie.Should().Be(0U, "Expecting the scope to be the whole solution");
            ...
            // Act + Assert
            VsShellUtils.SaveSolution(serviceProvider, silent: false)
                .Should().BeTrue();
        ...
        public void VsShellUtils_GetOrCreateSonarLintOutputPane()
        {
            ...
            sonarLintPane.Should().NotBeNull($"Expected returned pane to be of type {nameof(ConfigurableVsOutputWindowPane)}");

            sonarLintPane.IsActivated
                .Should().BeTrue("Expected pane to be activated");
