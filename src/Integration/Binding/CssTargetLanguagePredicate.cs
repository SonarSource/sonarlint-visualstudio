...
{
    public class CssTargetLanguagePredicate : ITargetLanguagePredicate
    {
        public static readonly CssTargetLanguagePredicate Instance = new CssTargetLanguagePredicate();
