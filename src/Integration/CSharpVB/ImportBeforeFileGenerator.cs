...
/// </summary>
public interface IImportBeforeFileGenerator : IRequireInitialization;
...
internal class ImportBeforeFileGenerator : IImportBeforeFileGenerator
{
    ...
    public ImportBeforeFileGenerator(ILogger logger,
        ...
        IInitializationProcessorFactory initializationProcessorFactory)
    {
        ...
        this.logger = logger.ForContext(Strings.ImportsBeforeFileGeneratorLogContext);
        InitializationProcessor = initializationProcessorFactory.CreateAndStart<ImportBeforeFileGenerator>([], UpdateOrCreateTargetsFile);
    }

    private const string TargetsFileName = "SQVS.targets";
    private const string ResourcePath = "SonarLint.VisualStudio.Integration.CSharpVB.SQVS.targets.xml";
