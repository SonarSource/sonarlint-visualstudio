...
namespace SonarLint.VisualStudio.TypeScript.UnitTests.Analyzer
{
    ...
    public class JavaScriptAnalyzerTests
    {
        ...
        public async Task ExecuteAnalysis_AlwaysCollectsTelemetry()
        {
            ...
            await testSubject.ExecuteAsync("js", nameof(JavaScriptAnalyzer), ValidFilePath, Mock.Of<IIssueConsumer>(), CancellationToken.None);
        ...
        public async Task ExecuteAnalysis_ResponseWithNoIssues_ConsumerNotCalled()
        {
            ...
            await testSubject.ExecuteAsync("js", nameof(JavaScriptAnalyzer), ValidFilePath, consumer.Object, CancellationToken.None);
        ...
        public void ExecuteAnalysis_CriticalException_ExceptionThrown()
        {
            ...
            Func<Task> act = async () => await testSubject.ExecuteAsync("js", nameof(JavaScriptAnalyzer), ValidFilePath, Mock.Of<IIssueConsumer>(), CancellationToken.None);
        ...
        private IAnalysisStatusNotifierFactory CreateStatusNotifierFactory(IAnalysisStatusNotifier statusNotifier)
        {
            ...
            statusNotifierFactory.Setup(x => x.Create(nameof(JavaScriptAnalyzer), ValidFilePath)).Returns(statusNotifier);
