...
public class ServerConnectionsRepositoryTests
{
    ...
    public void TryGet_MultipleCalls_ShouldCacheReadFile()
    {
        var sonarQubeModel = GetSonarQubeJsonModel(new Uri("http://localhost:9000"));
        MockReadingFile(new ServerConnectionsListJsonModel { ServerConnections = [sonarQubeModel] });
        serverConnectionModelMapper.GetServerConnection(sonarQubeModel).Returns(new ServerConnection.SonarQube(new Uri(sonarQubeModel.ServerUri)));
    ...
    [TestMethod]
    public void GetAll_FileExistsAndIsEmpty_ReturnsEmptyList()
    {
        MockReadingFile(new ServerConnectionsListJsonModel());
    ...
    [TestMethod]
    public void GetAll_FileExistsAndHasConnection_MapsModel()
    {
        var cloudModel = GetSonarCloudJsonModel("myOrg");
        MockReadingFile(new ServerConnectionsListJsonModel { ServerConnections = [cloudModel] });
    ...
    [TestMethod]
    public void GetAll_ConnectionsExist_DoesNotFillCredentials()
    {
