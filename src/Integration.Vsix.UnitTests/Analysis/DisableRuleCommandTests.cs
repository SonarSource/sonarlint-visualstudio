...
namespace SonarLint.VisualStudio.Integration.Vsix.Analysis.UnitTests
{
    ...
    public class DisableRuleCommandTests
    {
        ...
        {
            var bindingConfiguration = new BindingConfiguration2(new BoundServerProject("solution", "server project", new ServerConnection.SonarCloud("org")), bindingMode, null);
