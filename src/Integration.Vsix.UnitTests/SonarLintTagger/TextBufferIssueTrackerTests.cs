...
namespace SonarLint.VisualStudio.Integration.UnitTests
{
    ...
    public class TextBufferIssueTrackerTests
    {
        ...
        public void WhenTaggerIsRegistered_AnalysisIsRequested()
        {
            ...
            {
                mockAnalyzerController.Verify(x => x.ExecuteAnalysis("foo.js", "utf-8", new AnalysisLanguage[] { AnalysisLanguage.Javascript }, testSubject, It.IsAny<ProjectItem>(), It.IsAny<CancellationToken>(), It.IsAny<IAnalyzerOptions>()), Times.Once);
            }
        }
        ...
        private void CheckAnalysisWasNotRequested()
        {
            mockAnalyzerController.Verify(x => x.ExecuteAnalysis(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<IEnumerable<AnalysisLanguage>>(),
                It.IsAny<IIssueConsumer>(), It.IsAny<ProjectItem>(), It.IsAny<CancellationToken>(), It.IsAny<IAnalyzerOptions>()), Times.Never);
        }
