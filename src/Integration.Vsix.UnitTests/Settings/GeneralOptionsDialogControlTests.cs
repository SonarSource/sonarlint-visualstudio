...
namespace SonarLint.VisualStudio.Integration.UnitTests.Settings
{
    ...
    public class GeneralOptionsDialogControlTests
    {
        ...
        {
            // Arrange & Act
            Action act = () => new GeneralOptionsDialogControl(null, new Mock<ICommand>().Object, new TestLogger());
        ...
        {
            // Arrange & Act
            Action act = () => new GeneralOptionsDialogControl(new Mock<ISonarLintSettings>().Object, new Mock<ICommand>().Object, null);
