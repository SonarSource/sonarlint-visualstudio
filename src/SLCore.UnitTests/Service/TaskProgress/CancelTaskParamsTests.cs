...
namespace SonarLint.VisualStudio.SLCore.UnitTests.Service.TaskProgress;

[TestClass]
public class CancelTaskParamsTests
{
    [TestMethod]
    public void Serialize_AsExpected()
    {
        var testSubject = new CancelTaskParams("TaskID_123");
