...
[TestClass]
public class GetAllProjectsResponseTests
{
    [TestMethod]
    public void Serialize_AsExpected()
    {
        var sonarProjects = new List<SonarProjectDto>
        {
            new("proj-key-1", "Project 1"),
            new("proj-key-2", "Project 2"),
        };

        var testSubject = new GetAllProjectsResponse(sonarProjects);
