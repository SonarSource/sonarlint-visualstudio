...
[TestClass]
public class FuzzySearchProjectsResponseTests
{
    [TestMethod]
    public void Serialize_AsExpected()
    {
        var topResults = new List<SonarProjectDto>
        {
            new("my-project-1", "My Project 1"),
            new("our-project-2", "Our Project 2"),
        };
        
        var testSubject = new FuzzySearchProjectsResponse(topResults);
