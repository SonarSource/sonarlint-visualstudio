...
//
//         var actualConnectionId = testSubject.GetConnectionIdFromServerConnection(uri, organisation);
//
...
//         var testSubject = new ConnectionIdHelper();
//
//         var actualConnectionId = testSubject.GetConnectionIdFromServerConnection(null, "something");
//
...
//         var testSubject = new ConnectionIdHelper();
//
//         var resultUri = testSubject.GetUriFromConnectionId(testSubject.GetConnectionIdFromServerConnection(uri, "something"));
//
...
//         var testSubject = new ConnectionIdHelper();
//
//         var resultConnectionId = testSubject.GetConnectionIdFromServerConnection(testSubject.GetUriFromConnectionId(connectionId), "something");
//
