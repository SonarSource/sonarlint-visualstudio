...
using SonarQube.Client.Api.V8_6;
using SonarQube.Client.Models;

namespace SonarQube.Client.Api.V10_2
{
    internal class GetTaintVulnerabilitiesWithCCTRequest : GetTaintVulnerabilitiesRequest
    {
        public override async Task<SonarQubeIssue[]> InvokeAsync(HttpClient httpClient, CancellationToken token)
        {
            getIssuesRequest = new GetIssuesWithCCTRequest();
