...
{
    [TestClass]
    public class HotspotsTableEventProcessorProviderTests
    {
        [TestMethod]
        public void MefCtor_CheckIsExported()
        {
            MefTestHelpers.CheckTypeCanBeImported<HotspotsTableEventProcessorProvider, ITableControlEventProcessorProvider>(null, new[]
            {
