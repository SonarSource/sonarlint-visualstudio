...
[TestClass]
public class ChangeTaintStatusViewModelTests
{
    [TestMethod]
    public void Ctor_InitializesWithAllowedStatuses()
    {
        ...
        var testSubject = new ChangeTaintStatusViewModel(null, allowedStatuses);
    ...
    public void Ctor_InitializesWithCurrentStatus()
    {
        ...
        var testSubject = new ChangeTaintStatusViewModel(currentStatus, allowedStatuses);
    ...
    {
        var testSubject = new ChangeTaintStatusViewModel(null, [ResolutionStatus.ACCEPT]);
