...
namespace SonarLint.VisualStudio.IssueVisualization.Security.UnitTests.OpenInIDE.Api
{
    ...
    public class HotspotToIssueVisualizationConverterTests
    {
        ...
        private SonarQubeHotspot CreateSonarQubeHotspot(string probability = "high", string filePath = "some path", IssueTextRange textRange = null, string message = "message",
            string ruleKey = "rule key", string lineHash = "linehash") =>
