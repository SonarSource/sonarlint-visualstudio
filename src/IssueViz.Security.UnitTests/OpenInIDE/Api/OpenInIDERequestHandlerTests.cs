...
namespace SonarLint.VisualStudio.IssueVisualization.Security.UnitTests.OpenInIDE.Api
{
    ...
    public class OpenInIDERequestHandlerTests_Orchestration
    {
        ...
        private readonly SonarQubeHotspot ValidServerHotspot = new SonarQubeHotspot("hotspotKey", null, null, null, null, null, null, null, null, null, DateTimeOffset.MinValue, DateTimeOffset.MaxValue, null, null, null);
