...
namespace SonarLint.VisualStudio.IssueVisualization
{
    ...
    [ProvideToolWindow(typeof(IssueVisualizationToolWindow), MultiInstances = false, Orientation = ToolWindowOrientation.Left, Style = VsDockStyle.Tabbed, Window = ToolWindowGuids.SolutionExplorer, Width = 325, Height = 400)]
