...
namespace SonarLint.VisualStudio.IssueVisualization {
    ...
    public class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Could not apply Quick Fix for {0}. Please reanalyze the file and try again..
        /// </summary>
        public static string QuickFixSuggestedAction_CouldNotApply {
            get {
                return ResourceManager.GetString("QuickFixSuggestedAction_CouldNotApply", resourceCulture);
            }
        }
        ...
        public static string QuickFixSuggestedAction_LogContext {
            get {
                return ResourceManager.GetString("QuickFixSuggestedAction_LogContext", resourceCulture);
            }
        }
