    ...
    public List<TestIssue> ExpectedIssues
    {
        get
        {
            ...
            [
                ...
                new("Web:LinksIdenticalTextsDifferentTargetsCheck", new TextRangeDto(6, 0, 6, 49), CleanCodeAttribute.CONVENTIONAL, 0),
                new(WebS6844RuleKey, new TextRangeDto(7, 4, 7, 21), CleanCodeAttribute.CONVENTIONAL, 0),
                new("Web:LinksIdenticalTextsDifferentTargetsCheck", new TextRangeDto(7, 0, 7, 40), CleanCodeAttribute.CONVENTIONAL, 0),
