...
namespace SonarLint.VisualStudio.IssueVisualization.Security {
    ...
    public class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to clear all current filters.
        /// </summary>
        public static string NoFindingsToDisplayCurrentClearFiltersLink {
            get {
                return ResourceManager.GetString("NoFindingsToDisplayCurrentClearFiltersLink", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Please select different filters or.
        /// </summary>
        public static string NoFindingsToDisplayCurrentFiltersTitle {
            get {
                return ResourceManager.GetString("NoFindingsToDisplayCurrentFiltersTitle", resourceCulture);
            }
        }
