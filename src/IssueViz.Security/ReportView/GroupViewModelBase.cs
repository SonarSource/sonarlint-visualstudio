...
internal abstract class GroupViewModelBase(string title, string filePath) : ViewModelBase, IGroupViewModel
{
    ...
    private IEnumerable<IIssueViewModel> OrderIssues(IEnumerable<IIssueViewModel> issuesToShow) => issuesToShow.OrderByDescending(vm => vm.DisplaySeverity, DisplaySeverityComparer.Instance);

    private IEnumerable<IIssueViewModel> PreFilter(ReportViewFilterViewModel reportViewFilter, IEnumerable<IIssueViewModel> issuesToShow)
    {
    ...
    private IEnumerable<IIssueViewModel> FilterIssues(ReportViewFilterViewModel reportViewFilter, IEnumerable<IIssueViewModel> filteredIssues)
    {
