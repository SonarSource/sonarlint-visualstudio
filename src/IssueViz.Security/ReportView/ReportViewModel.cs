...
internal class ReportViewModel : ServerViewModel, IReportViewModel
{
    ...
    private void DocumentTracker_DocumentClosed(object sender, DocumentEventArgs e) =>
        threadHandling.RunOnUIThread(() =>
        {
            ...
            FilteredGroupViewModels.Remove(group);
    ...
    public bool HasNoFilteredIssuesForGroupsWithIssues => FilteredGroupViewModels.All(x => !x.FilteredIssues.Any() && x.PreFilteredIssues.Any());
