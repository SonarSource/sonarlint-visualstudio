...
internal interface IReviewHotspotsService
{
...
internal record ReviewHotspotPermittedArgs(IEnumerable<HotspotStatus> AllowedStatuses) : IReviewHotspotPermissionArgs;
internal record ReviewHotspotNotPermittedArgs(string Reason) : IReviewHotspotPermissionArgs;
