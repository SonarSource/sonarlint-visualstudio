...
public static class HotspotStatusExtensionMethods
{
    public static SlCoreHotspotStatus ToSlCoreHotspotStatus(this CoreHotspotStatus coreStatus) => (SlCoreHotspotStatus)(int)coreStatus;
}
