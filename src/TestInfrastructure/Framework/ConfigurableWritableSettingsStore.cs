...
namespace SonarLint.VisualStudio.Integration.UnitTests
{
    public class ConfigurableWritableSettingsStore : WritableSettingsStore
    {
        ...
        public void AssertCollectionPropertyCount(string collectionPath, int numProperties)
        {
            ...
            numProperties.Should().Be(properties.Count, $"Unexpected number of properties in collection '{collectionPath}'. Properties: {string.Join(", ", properties)}");
        }
        ...
        public void AssertBoolean(string collectionPath, string key, bool value)
        {
            ...
            collection.Should().ContainKey(key, $"Property '{key}' was missing from collection '{collectionPath}'. Properties: {string.Join(", ", collection.Keys)}");
