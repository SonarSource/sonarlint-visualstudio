...
namespace SonarLint.VisualStudio.Integration.UnitTests
{
    internal class ConfigurableConnectionWorkflow : IConnectionWorkflowExecutor
    {
        ...
        void IConnectionWorkflowExecutor.EstablishConnection(ConnectionInformation information)
        {
            ...
            var success = this.sonarQubeService.TryGetProjects(information, CancellationToken.None, out this.lastConnectedProjects);

            success.Should().BeTrue("Failed to establish connection");
        }
        ...
        {
            expectedNumberOfCalls.Should().Be(this.numberOfCalls, "EstablishConnection was called unexpected number of times");
        }
        #endregion
    }
}
