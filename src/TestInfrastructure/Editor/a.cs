...
namespace SonarLint.VisualStudio.Integration.TestInfrastructure.Editor;

public class TestableNormalizedTextChangeCollection : INormalizedTextChangeCollection
{
