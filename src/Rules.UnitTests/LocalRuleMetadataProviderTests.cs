    ...
    public class LocalRuleMetadataProviderTests
    {
        ...
        public void GetRuleHelp_CheckAllRules()
        {
            ...
            void CheckRule(string fullResourceName)
            {
                ...
                var expectedRuleInfo = GetEmbeddedRuleDescription(fullResourceName);
                ...
                if (actual.DescriptionSections.Count > 0)
                {
        ...
        private static IRuleInfo GetEmbeddedRuleDescription(string fullResourceName)
        {
