...
namespace SonarLint.VisualStudio.Integration.Vsix.Resources {
    ...
    public class Strings {
        ...
        public static string Analysis_ErrorOnFileAction {
            get {
                return ResourceManager.GetString("Analysis_ErrorOnFileAction", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Could not locate Java using {0}.
        /// </summary>
        public static string GlobalJreProvider_CouldNotLocateJava {
            get {
                return ResourceManager.GetString("GlobalJreProvider_CouldNotLocateJava", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Error finding Java using {0}: {1}.
        /// </summary>
        public static string GlobalJreProvider_ErrorFindingJava {
            get {
                return ResourceManager.GetString("GlobalJreProvider_ErrorFindingJava", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Java executable found using {0}: {1}.
        /// </summary>
        public static string GlobalJreProvider_JavaExecutableFound {
            get {
                return ResourceManager.GetString("GlobalJreProvider_JavaExecutableFound", resourceCulture);
            }
        }
