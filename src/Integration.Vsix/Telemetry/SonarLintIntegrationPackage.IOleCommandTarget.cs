...
namespace SonarLint.VisualStudio.Integration.Vsix
{
    ...
    partial class SonarLintIntegrationPackage : IOleCommandTarget
    {
        ...
        private void InitializeSqm()
        {
            ...
            // It's possible that one of the command line packages has already initialized
            // the facade. However, calling it multiple times won't cause an error.
        ...
        int IOleCommandTarget.QueryStatus(ref Guid pguidCmdGroup, uint cCmds, OLECMD[] prgCmds, IntPtr pCmdText)
        {
            ...
            Debug.Assert(result == (int)OLEConstants.OLECMDERR_E_NOTSUPPORTED ||
                result == (int)VSConstants.S_OK, "Unexpected return value from the generated SQM target handler");
