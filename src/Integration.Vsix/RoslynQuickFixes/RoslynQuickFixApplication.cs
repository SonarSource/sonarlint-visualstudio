...
public class RoslynQuickFixApplication(RoslynQuickFixApplicationImpl implementation) : IQuickFixApplication
{
    ...
    public bool CanBeApplied(ITextSnapshot currentSnapshot) => true; // todo??

    public Task ApplyAsync(ITextSnapshot currentSnapshot, CancellationToken cancellationToken) => implementation.ApplyAsync(cancellationToken);
}
