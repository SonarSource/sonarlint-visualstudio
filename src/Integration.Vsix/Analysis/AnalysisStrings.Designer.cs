...
namespace SonarLint.VisualStudio.Integration.Vsix.Analysis {
    ...
    internal class AnalysisStrings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Aborted analysis {0} of {1}, analysis has been re-triggered or has timed-out..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Analysis {0} failed for files {1}. Reason: {2}.
        /// </summary>
