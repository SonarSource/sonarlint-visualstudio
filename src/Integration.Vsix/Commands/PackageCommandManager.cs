...
namespace SonarLint.VisualStudio.Integration.Vsix
{
    internal class PackageCommandManager
    {
        ...
        public async Task InitializeAsync(IAsyncServiceProvider asyncServiceProvider, ShowOptionsPage showOptionsPage)
        {
            ...
            var pluginStatusesStore = await asyncServiceProvider.GetMefServiceAsync<IPluginStatusesStore>();
            var threadHandling = await asyncServiceProvider.GetMefServiceAsync<IThreadHandling>();
