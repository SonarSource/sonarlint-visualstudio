...
{
    internal class TSConfigResponse
    {
        /// <summary>
        /// File paths to source files referenced by the tsconfig file
        /// </summary>
        [JsonProperty("files")]
        public IEnumerable<string> Files { get; set; }

        /// <summary>
        /// File paths of referenced projects that should be resolved by calling "tsconfig-files"
        /// </summary>
