...
namespace SonarLint.VisualStudio.IssueVisualization.UnitTests.IssueVisualizationControl
{
    ...
    public class InvertedBooleanToVisibilityConverterTests
    {
        ...
        {
            var result = new InvertedBooleanToVisibilityConverter().Convert(value, null, null, null);
        ...
        {
            Action act = () => new InvertedBooleanToVisibilityConverter().ConvertBack(null, null, null, null);
