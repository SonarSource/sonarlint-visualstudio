...
internal class NonRoslynDummyBindingConfigProvider : IBindingConfigProvider
{
    ...
    internal NonRoslynDummyBindingConfigProvider(ILanguageProvider languageProvider)
    {
        this.languageProvider = languageProvider;
    }

    public bool IsLanguageSupported(Language language) => languageProvider.NonRoslynLanguages.Contains(language);
