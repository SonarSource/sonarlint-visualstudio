...
{
    public DeleteConnectionDialogViewModel(IReadOnlyList<string> projectsToUnbind, ConnectionInfo.Connection connectionInfo)
    {
    ...
    public ConnectionInfo.Connection ConnectionInfo { get; }
