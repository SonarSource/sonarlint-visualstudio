...
namespace SonarLint.VisualStudio.ConnectedMode.UI.Resources {
    ...
    public class UiResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Failed to update the connection: {0}.
        /// </summary>
        public static string UpdatingConnectionCredentialsFailedWithReasonTextTemplate {
            get {
                return ResourceManager.GetString("UpdatingConnectionCredentialsFailedWithReasonTextTemplate", resourceCulture);
            }
        }
