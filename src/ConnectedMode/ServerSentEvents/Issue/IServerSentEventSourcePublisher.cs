...
namespace SonarLint.VisualStudio.ConnectedMode.SonarQubeClient
{
    ...
    /// </summary>
    /// <remarks>This interface is not intended to be thread sa/// The only permitted type of multi threaded calling is calling Publish and Dispose concurrently, although it may re/// <typeparam name="T">Server sent event type inherited from <see cref="IServerEvent"/></typeparam>nt type inherited from <see cref="IServerEvent"/></typeparam>ypeparam>
