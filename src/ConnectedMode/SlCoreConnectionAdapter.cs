...
public interface ISlCoreConnectionAdapter
{
    ...
    Task<ResponseStatus<List<OrganizationDisplay>>> GetOrganizationsAsync(ICredentialsModel credentialsModel, CloudServerRegion cloudServerRegion);


    Task<ResponseStatus<ServerProject>> GetServerProjectByKeyAsync(ServerConnection serverConnection, string serverProjectKey);

    Task<ResponseStatus<List<ServerProject>>> GetAllProjectsAsync(ServerConnection serverConnection);

    Task<ResponseStatus<List<ServerProject>>> FuzzySearchProjectsAsync(ServerConnection serverConnection, string searchTerm);

    Task<ResponseStatus<string>> GenerateTokenAsync(ConnectionInfo connectionInfo, CancellationToken cancellationToken);
}
...
{
    private static readonly ResponseStatus<List<OrganizationDisplay>> FailedResponseWithData = new(false, []);
    ...
    public Task<ResponseStatus<List<OrganizationDisplay>>> GetOrganizationsAsync(ICredentialsModel credentialsModel, CloudServerRegion cloudServerRegion) =>
        threadHandling.RunOnBackgroundThread(async () =>
        {
            ...
            try
            {
                ...
                return new ResponseStatus<List<OrganizationDisplay>>(true, organizationDisplays);
            }
            catch (Exception ex)
            {
    ...
    public Task<ResponseStatus<ServerProject>> GetServerProjectByKeyAsync(ServerConnection serverConnection, string serverProjectKey)
    {
        var failedResponse = new ResponseStatus<ServerProject>(false, null);
        ...
        return threadHandling.RunOnBackgroundThread(async () =>
        {
            ...
            try
            {
                ...
                return new ResponseStatus<ServerProject>(true, new ServerProject(serverProjectKey, response.projectNamesByKey[serverProjectKey]));
            }
            catch (Exception ex)
            {
    ...
    public async Task<ResponseStatus<List<ServerProject>>> GetAllProjectsAsync(ServerConnection serverConnection)
    {
    ...
    public async Task<ResponseStatus<List<ServerProject>>> FuzzySearchProjectsAsync(ServerConnection serverConnection, string searchTerm)
    {
        var failedResponse = new ResponseStatus<List<ServerProject>>(false, []);
        return await threadHandling.RunOnBackgroundThread(async () =>
        {
            ...
            try
            {
                ...
                return new ResponseStatus<List<ServerProject>>(true, serverProjects);
            }
            catch (Exception ex)
            {
    ...
    public async Task<ResponseStatus<string>> GenerateTokenAsync(ConnectionInfo connectionInfo, CancellationToken cancellationToken)
    {
        var failedResponse = new ResponseStatus<string>(false, null);
        return await threadHandling.RunOnBackgroundThread(async () =>
        {
            if (!TryGetConnectionConfigurationSlCoreService(out var connectionConfigurationSlCoreService))
            {
            ...
            try
            {
                ...
                return new ResponseStatus<string>(true, slCoreResponse.token);
            }
            catch (Exception ex)
            {
    ...
    private async Task<ResponseStatus<List<ServerProject>>> GetAllProjectsAsync(GetAllProjectsParams getAllProjectsParams)
    {
        var failedResponse = new ResponseStatus<List<ServerProject>>(false, []);
        return await threadHandling.RunOnBackgroundThread(async () =>
        {
