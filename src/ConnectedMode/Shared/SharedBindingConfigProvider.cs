...
namespace SonarLint.VisualStudio.ConnectedMode.Shared
{
    internal class SharedBindingConfigProvider : ISharedBindingConfigProvider
    {
        ...
        public SharedBindingConfigProvider(IGitWorkspaceService gitWorkspaceService, ISharedFolderProvider sharedFolderProvider, ISolutionInfoProvider solutionInfoProvider)
        {
