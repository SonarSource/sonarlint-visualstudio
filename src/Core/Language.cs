...
namespace SonarLint.VisualStudio.Core
{
    ...
    public class Language : IEquatable<Language>
    {
        ...
        private static readonly PluginInfo CSharpPlugin = new("csharpenterprise", $"sonar-csharp-enterprise-plugin-{VersionNumberPattern}.jar", isEnabledForAnalysis: false, isEnabledInStandaloneMode: false);
        private static readonly PluginInfo OssCSharpPlugin = new("csharp", $"sonar-csharp-plugin-{VersionNumberPattern}.jar", isEnabledForAnalysis: false);
        private static readonly PluginInfo VbNetPlugin = new("vbnetenterprise", $"sonar-vbnet-enterprise-plugin-{VersionNumberPattern}.jar", isEnabledForAnalysis: false, isEnabledInStandaloneMode: false);
        private static readonly PluginInfo OssVbNetPlugin = new("vbnet", $"sonar-vbnet-plugin-{VersionNumberPattern}.jar", isEnabledForAnalysis: false);
        ...
        public static readonly RoslynLanguage CSharp = new("CSharp", CoreStrings.CSharpLanguageName, "cs", SqvsRoslynPlugin, CSharpRepo,
            settingsFileName: "sonarlint_csharp.globalconfig", roslynDllIdentifier: ".CSharp.", CSharpSecurityRepo, additionalPlugins: [CSharpPlugin, OssCSharpPlugin]);
        public static readonly RoslynLanguage VBNET = new("VB", CoreStrings.VBNetLanguageName, "vbnet", SqvsRoslynPlugin, VbNetRepo, settingsFileName: "sonarlint_vb.globalconfig", roslynDllIdentifier: ".VisualBasic.",
            additionalPlugins: [VbNetPlugin, OssVbNetPlugin]);
