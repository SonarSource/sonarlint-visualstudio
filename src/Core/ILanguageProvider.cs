...
#pragma warning restore S4277
    ...
    public IReadOnlyList<Language> NonRoslynLanguages { get; } = [Language.C, Language.Cpp, Language.Js, Language.Ts, Language.Css, Language.Secrets, Language.Html, Language.TSql, Language.Text, Language.Shell, Language.AzurePipelines];
    ...
    public IReadOnlyList<Language> ExtraLanguagesInConnectedMode { get; } = [Language.TSql, Language.Text, Language.Shell, Language.AzurePipelines];
