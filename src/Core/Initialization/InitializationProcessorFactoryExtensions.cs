...
{
    public static IInitializationProcessor CreateAndStart<T>(
        this IInitializationProcessorFactory factory,
        IReadOnlyCollection<IRequireInitialization> dependencies,
        Action initialization) =>
        factory.CreateAndStart<T>(dependencies, _ =>
        {
            initialization();
    ...
    public static IInitializationProcessor CreateAndStart<T>(
        ...
        factory.CreateAndStart<T>(dependencies, _ => initialization());
