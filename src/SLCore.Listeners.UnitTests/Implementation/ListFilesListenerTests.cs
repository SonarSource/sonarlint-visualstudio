...
//         {
//             MefTestHelpers.CheckTypeCanBeImported<ListFilesListener, IListFilesListener>(
...
//
//             files[0].uri.Should().Be(new Uri("C:\\Code\\Project\\File1.js"));
...
//
//             files[1].uri.Should().Be(new Uri("C:\\Code\\Project\\File2.js"));
...
//
//             files[2].uri.Should().Be(new Uri("C:\\Code\\Project\\Folder1\\File3.js"));
