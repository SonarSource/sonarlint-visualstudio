...
public class CertificateChainValidatorTests
{
    ...
    {
        MefTestHelpers.CheckTypeCanBeImported<CertificateChainValidator, ICertificateChainValidator>(
    ...
    {
        MefTestHelpers.CheckIsSingletonMefComponent<CertificateChainValidator>();
    }
}
