...
public class BranchListenerTests
{
    ...
    [TestMethod]
    public Task MatchProjectBranchAsync_ThrowsNotImplemented()
    {
        return Assert.ThrowsExceptionAsync<NotImplementedException>(() => testSubject.MatchProjectBranchAsync(null));
    }
}
