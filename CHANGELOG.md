...
### New Feature
* #267 - SonarLint should not show issues marked as FP or Won't Fix

### Improvement
* #257 - Update the Marketplace Icon
* #378 - Embed SonarC# 6.5 and SonarVB 3.1
* #278 - Unify the telemetry behavior with other SonarLint IDEs

### Bug
* #380 - Typo on SonarLint for VS 2017 marketplace page
* #383 - Binding to a project on SonarCloud always prompt for organization


## [3.5]

### Improvement
* #252 - Embed SonarC# 6.4

### Bug
* #244 - Spelling error in additional languages download dialog
* #243 - The 'SonalLintDaemonPackage' package did not load correctly.
...
### Improvement
* #239 - Embed SonarC# 6.3
* #235 - Update SonarJS to version 3.1
* #234 - Include Visual Studio version in telemetry data

### Bug
* #228 - VisualStudio Enterprise considers the extension is slowing down the startup


## [3.3]

### Improvement
* #223 - Embed SonarC# 6.2
* #202 - Update SonarLint extension description

## [3.2.1]

### Bug
* #216 - Fix broken analyzer reference


## [3.2]

### Improvement
* #211 - Embed SonarC# 6.1


## [3.1.1]

### Bug
* #207 - Fix a connectivity problem with SonarCloud


## [3.1]

### Improvement
* #204 - Embed SonarC# 6.0


## [3.0]

### New Feature
* #164 - Provide support for Javascript in standalone
* #173 - Add support for SonarQube organizations in connected mode
* #142 - Add telemetry

### Improvement
* #199 - Embed SonarC# 5.11
* #156 - SonarLint is not listed in the Help/About of Visual Studio
* #136 - Provide a digital signature to the extension


## [2.13]

### Improvement
* #154 - Embed SonarC# 5.10


## [2.12]

### Improvement
* #135 - Embed SonarC# 5.9

### Bug
* #132 - SonarLint for VS2017 crashes when VS2015 is not installed
